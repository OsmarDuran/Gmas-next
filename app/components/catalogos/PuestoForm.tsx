...
export function PuestoForm({ initialData, onSuccess, onCancel }: PuestoFormProps) {
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            <div>
                ...
                <input
                    ...
                    placeholder="Ej. Analista de Sistemas, Gerente de Ventas"
                />
            </div>
            ...
            <div className="flex justify-end gap-3 pt-4 border-t border-gray-200 dark:border-zinc-700">
                ...
                >
                    ...
                    {initialData ? "Guardar Cambios" : "Crear Puesto"}
                </button>
            </div>
        </form>
    );
